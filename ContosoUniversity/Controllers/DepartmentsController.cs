    ...
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id, byte[] rowVersion)
        {
            ...
            try
                ...
                {
                    var exceptionEntry = ex.Entries.Single(); //Entity that fails in being saved
                    var clientValues = (Department)exceptionEntry.Entity; //Convert to Domaine Entity
                    var databaseEntry = exceptionEntry.GetDatabaseValues(); //Get Database version of Entity
                    if (databaseEntry == null) //Does not exist anymore
                    {
                        ModelState.AddModelError(string.Empty,
                            "Unable to save changes. The department was deleted by another user.");
                    }
                    ...
                    {
                        var databaseValues = (Department)databaseEntry.ToObject();//Convert DB entity to Domaine entity

                        if (databaseValues.Name != clientValues.Name) //Compare Domaine and DB Entity attributes
                        {
